...
/// Show border-only window AROUND selection position for scroll capture.
/// Window is larger than selection so border is OUTSIDE capture rect.
/// This means screencapture won't capture the border.
#[tauri::command]
